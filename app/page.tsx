      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="mt-8 p-4 rounded-lg bg-card border border-border">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            hook from wagmi to batch multiple Ethereum transactions together.
            Connect your wallet, select a network, and add transactions to get
            started.
          </p>
        </div>
        ...
        <div className="mt-6 flex justify-center">
          <a
            href="https://github.com/gskril/batch-transactions"
            target="_blank"
